...
you can convert (a,b) to (c,d) by performance zero or more the operations specified above. 
...
public class conversion{
    public static void main(String args[]){
        ...
        int c=sc.nextInt();
        int d=sc.nextInt();
        boolean ans=check_equal(a,b,c,d);
        System.out.println(ans);
    }
    public static boolean check_equal(int a,int b,int c,int d){
        if(a==c && b==d) return true;
        else if(a>c || b>d) return false;
        return check_equal(a,a+b,c,d) || check_equal(a+b,b,c,d);
    }
}